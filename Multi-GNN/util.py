...
def create_parser():
    ...
    parser.add_argument("--emb", default=None, type=str, help="Select the HTNE embedding type. Should be old or new.", required=True)
    parser.add_argument("--emb_path", default=None, type=str, help="Select the embedding path.", required=True)
    parser.add_argument("--desc", default=None, type=str, help="Description for the run.", required=True)
    parser.add_argument("--timestamp", default=None, type=str, help="Timestamp for the Multi-GNN tests ran from ~/TGEditor/src.", required=True)
